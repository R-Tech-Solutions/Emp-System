...
function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Timesheets", path: "/timesheets", icon: <ListChecks className="w-5 h-5" /> },
    { name: "Attendance", path: "/attendance", icon: <Clock className="w-5 h-5" /> },
    { name: "Leave Requests", path: "/leave-requests", icon: <Calendar className="w-5 h-5" /> },
    { name: "Payroll", path: "/payroll", icon: <Package className="w-5 h-5" /> },
    ...
    { name: "Expence", path: "/expence", icon: <Package className="w-5 h-5" /> },
    { name: "Income", path: "/income", icon: <Package className="w-5 h-5" /> },
  ];
