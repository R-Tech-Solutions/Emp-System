            ...
            <>
              <div className="mt-8 flex border-b border-border">
                <button
                  ...
                  className={`flex-1 py-2 text-sm font-medium text-center transition-colors ${activeTab === "email"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.email ? "border-red-500" : "border-border"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`appearance-none block w-full pl-10 pr-10 py-3 border ${errors.password ? "border-red-500" : "border-border"
                          } rounded-md shadow-sm placeholder-text-muted bg-surface text-text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors`}
                        placeholder="••••••••"
                      />
                      <button
